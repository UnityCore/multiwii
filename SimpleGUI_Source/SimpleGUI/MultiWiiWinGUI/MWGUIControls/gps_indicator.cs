...
namespace MultiWiiGUIControls
{
    class GpsIndicatorInstrumentControl : MWGUIControl
    {
        ...
        Bitmap bmpLeftLedGreen = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.gps_left_led_green1);
        Bitmap bmpLeftLedRed = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.gps_left_led_red1);

        Bitmap bmpRightLedGreen = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.gps_right_led_green1);
        Bitmap bmpRightLedRed = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.gps_right_led_red1);

        Bitmap bmpHeadingWheel = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.gps_direction1);
        Bitmap bmpSatGreen = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.gps_sat_green1);
        Bitmap bmpSatRed = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.gps_sat_red1);
        Bitmap bmpBackGround = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.gps_background1);
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            pe.Graphics.DrawString(String.Format("{0:0}",Numsat), drawSatFont, drawBrush, 100, 64);
