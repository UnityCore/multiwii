...
namespace MultiWiiGUIControls
{
    class heading_indicator : MWGUIControl
    {
        ...
        // Images
        Bitmap bmpBackground = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.HeadingIndicator_Background1);
        //Bitmap bmpHeadingwheel = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.HeadingIndicator_Aircraft1);
        Bitmap bmpHeadingwheel1 = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.HeadingWeel1);
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            gfx.TranslateTransform(-68f, -68f);
            gfx.DrawImageUnscaled(bmpHeadingwheel1, 0, 0);
