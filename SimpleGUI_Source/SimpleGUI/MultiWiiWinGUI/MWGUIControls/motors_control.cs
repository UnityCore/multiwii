...
namespace MultiWiiGUIControls
{
    class MWGUIMotors : MWGUIControl
    {
        ...
        Bitmap bmpQuadX = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.quadx1);
        Bitmap bmpQuadP = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.quadp1);
        Bitmap bmpTri = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.tri1);
        Bitmap bmpY6 = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.y61);
        Bitmap bmpY4 = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.y41);
        Bitmap bmpBi = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.bicopter1);
        Bitmap bmpHex6 = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.hex61);
        Bitmap bmpHex6X = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.hex6x1);
        Bitmap bmpFw = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.fw1);
        Bitmap bmpGimbal = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.gimbal1);
        Bitmap bmpOcto8x = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.octo8x1);
        Bitmap bmpOcto8p = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.octo8p1);
        Bitmap bmpOcto8c = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.octo8coax1);
        Bitmap bmpAirplane = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.airplane1);
        Bitmap bmpHeli120 = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.heli_1201);
        Bitmap bmpHeli90 = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.heli_901);
        Bitmap bmpVtail = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.vtail1);
