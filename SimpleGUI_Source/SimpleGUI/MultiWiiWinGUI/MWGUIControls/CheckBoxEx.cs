...
namespace MultiWiiGUIControls
{
    ...
    //class derived from the CheckBox class
    {
        ...
        private static Brush lightgrayBrush = new SolidBrush(Color.WhiteSmoke);
        private static Brush grayBrush = new SolidBrush(Color.Gray);
        private static Brush lightgreenBrush = new SolidBrush(Color.FromArgb(123, 194, 205));
        private static Brush orangeBrush = new SolidBrush(Color.Red);
        private static Pen orangePen = new Pen(orangeBrush, 2);
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            pe.Graphics.FillRectangle(lightgrayBrush, 1, 1, 13, 12);

            if (this.Checked) pe.Graphics.FillRectangle(lightgreenBrush, 1, 1, 13, 12);
            if (h) pe.Graphics.DrawRectangle(orangePen, 1, 1, 13, 12);
        }
