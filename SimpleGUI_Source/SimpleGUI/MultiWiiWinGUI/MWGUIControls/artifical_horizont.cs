...
namespace MultiWiiGUIControls
{
    class artifical_horizon : MWGUIControl
    {
       ...
       private bool   bIndicatorType      = false;            //normal artifical horizon
        ...
        // Images
        //Bitmap bmpBackground = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.Horizon_Background);
        Bitmap bmpEmptyBackground = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.Horizon_empty_Background1);
        Bitmap bmpHorizon = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.Horizon_GroundSky1);
        Bitmap bmpPlane = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.Maquette_Avion1);
        Bitmap bmpToggleON = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.toggle_on1);
        Bitmap bmpToggleOFF = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.toggle_off1);
        Bitmap bmpRoll = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.roll1);
        Bitmap bmpPitch = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.pitch1);
        Bitmap bmpBackground = new Bitmap(MultiWiiSimpleGUI.MWGUIControls.MWGUIControlsResources.Horizon_Background1);
